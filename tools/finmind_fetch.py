...
DEFAULT_PICKS = [
    ...
    ("00892", "富邦台灣半導體"),
    # ETF 補齊(2026-06 加:BWIBBU 報表不含 ETF,熱門市值/高息 ETF 需在此明列才會抓)
    ("0050", "元大台灣50"), ("006208", "富邦台50"), ("0056", "元大高股息"),
    ("00878", "國泰永續高股息"), ("00929", "復華台灣科技優息"),
    ("00891", "中信關鍵半導體"), ("00907", "永豐優息存股"),
    ("00915", "凱基優選高股息30"), ("00922", "國泰台灣領袖50"),
    ("00923", "群益台ESG低碳50"), ("00933", "凱基優選永續高息30"),
    ("00944", "野村趨勢動能高股息"), ("00951", "統一台灣高股息動能"),
    ("00952", "永豐臺灣科技優息"),
]
